...
- [ ] `P20-002` Strengthen restart/resume reliability: reconcile in-progress agent/task state after process restarts without status drift or duplicate execution. **Status: InProgress**. Deps: `P19-005`.
