...
- [ ] `P20-003` Tighten phase-loop preflight consistency (branch/worktree gating and deterministic error semantics across manual/auto mode). **Status: InProgress**. Deps: `P20-001`, `P20-002`.
