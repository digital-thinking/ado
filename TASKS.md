...
- [ ] `P20-004` Add loop-level safeguards for duplicate CI_FIX generation and ensure deduplication/idempotency across repeated tester failures. **Status: InProgress**. Deps: `P20-003`.
