...
- [ ] `P22-005` Introduce a structured runtime event contract shared across CLI/Web/Telegram for task lifecycle, adapter output, tester/recovery, and terminal outcomes. **Status: InProgress**. Deps: `P22-004`.
