...
- [ ] `P15-005` Split web control-center frontend script in `src/web/app.ts` into focused modules/functions (settings, agents, kanban, runtime/project tabs, API client) while preserving current behavior and endpoints. **Status: InProgress**. Deps: `P15-001`.
