...
- [ ] `P15-007` Extract repeated CLI integration-test harness utilities (spawn wrapper, temp project/bootstrap helpers) into shared test helpers and migrate existing CLI command tests to those helpers. **Status: InProgress**. Deps: `P15-004`.
