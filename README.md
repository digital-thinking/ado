...
- **Lifecycle Hooks:** Strict typed extension points for `before_task_start`, `after_task_done`, `on_recovery`, and `on_ci_failed`, executed in the primary phase-runner/tester/recovery flow with fail-fast error propagation.
